...
const styles = StyleSheet.create({
  ...
  accountInfo: { flex: 1 },
  accountName: { fontSize: FontSize.lg, fontWeight: '900', color: Colors.text },
  ...
  platformBadge: { backgroundColor: Colors.infoBg, borderRadius: BorderRadius.full, paddingHorizontal: Spacing.sm, paddingVertical: 4 },
